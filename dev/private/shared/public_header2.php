...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <title>Email <?php if(isset($page_title)) { echo '- ' . h($page_title); } ?></title>
     <style type="text/css">
      <?php
      include PUBLIC_PATH . '/stylesheets/mailchimp.bootstrap.min.css';
      include PUBLIC_PATH . '/stylesheets/mailchimp.min.css';
      // include PUBLIC_PATH . '/stylesheets/public.min.css';
      include PUBLIC_PATH . '/stylesheets/' . strtolower($stationName) . '.min.css'; ?>

...
<head>
    ...
    <title>Email <?php if ( isset( $page_title ) ) {
		echo '- ' . h( $page_title ); } ?></title>
    <style type="text/css">
    <?php include PUBLIC_PATH . '/stylesheets/bootstrap.min.css';
                                                            ...
                                                            <td class="mcnImageContent" valign="top"
                                                                ...
                                                                <a href="<?php echo $stationURL; ?>" target="_blank">
                                                                    <img align="center" alt="logo"
                                                                        src="http://bwaymedia.wpengine.com/wp-content/uploads/2018/11/<?php echo $stationName; ?>_logo.png"
                                                                        width="80"

<?php
	// Get station URLs
foreach ( Email::STATION_FB as $station_id => $station_fb ) {
	if ( $station == $station_id ) {
		  $stationfb = $station_fb;
		  break;
	}
}

foreach ( Email::STATION_TW as $station_id => $station_tw ) {
	if ( $station == $station_id ) {
		$stationtw = $station_tw;
		break;
	}
}

foreach ( Email::STATION_IG as $station_id => $station_ig ) {
	if ( $station == $station_id ) {
		  $stationig = $station_ig;
		  break;
	}
}

foreach ( Email::STATION_APP as $station_id => $station_app ) {
	if ( $station == $station_id ) {
		$stationapp = $station_app;
		break;
	}
}

foreach ( Email::STATION_GP as $station_id => $station_gp ) {
	if ( $station == $station_id ) {
		  $stationgp = $station_gp;
		  break;
	}
}
	  ...
	  <tbody>
		<tr>
		  <td valign="top" class="mcnCaptionRightContentInner" style="padding:0 9px ;">
			<table align="left" border="0" cellpadding="3" cellspacing="0" class="mcnCaptionRightImageContentContainer" width="282">
			  <tbody>
				<tr>
				  <td class="mcnCaptionRightImageContent" align="right" valign="top">
					<a href="<?php echo $stationapp; ?>">
					  <img alt="Download on App Store" src="http://bwaymedia.wpengine.com/wp-content/uploads/2019/12/DownloadonApp.png" width="120" class="mcnImage" style="max-width:150px;">
					</a>
				  </td>
				</tr>
			  </tbody>
			  ...
			  <tbody>
				<tr>
				  <td class="mcnCaptionRightImageContent" align="left" valign="top">
					<a href="<?php echo $stationgp; ?>">
					  <img alt="Download on Google Play" src="http://bwaymedia.wpengine.com/wp-content/uploads/2019/12/DownloadonGooglePlay.png" width="120" class="mcnImage" style="max-width:150px;">
					</a>
				  </td>
				</tr>
			  </tbody>
